...
SCTP(Stream Control Transmission Protocol)는 2000년 IETF RFC 2960으로 초안 제정되어 SS7 시그널링의 IP 망 수용이라는 구체적 요구를 배경으로 탄생하였으며, 이후 2007년 **RFC 4960**으로 개정·대체되어 현재의 표준으로 운용된다. VoIP 확산, 4G/5G 코어 네트워크 구축, IMS 아키텍처 도입과 함께 통신 인프라의 핵심 전송 프로토콜로 자리잡았다.
