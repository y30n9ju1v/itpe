...
정 의  • ICS(산업제어시스템) 환경의 네트워크 계층을 6단계로 구분하여 IT·OT 영역의 보안 경계를 정의한 참조 모델
...
- 파듀 모델은 OT/ICS 환경을 Level 0~4로 계층화하여 IT-OT 네트워크 간 DMZ 설치와 단방향 데이터 다이오드로 횡적 이동을 차단하는 ICS 보안 참조 아키텍처로, ISA/IEC 62443과 함께 산업제어시스템 보안 설계의 국제 표준 기반임.  "끝"
