...
- DRDoS는 공개 서버(DNS·NTP·SSDP)의 응답 증폭 특성을 악용해 공격자 IP를 숨기면서 수십~수백 배 트래픽을 발생시키며, 피해자 측의 스크러빙 센터 외에도 반사 서버에서의 BCP 38 필터링과 응답 속도 제한(Rate Limiting) 적용이 근본적 차단 방법임.  "끝"
