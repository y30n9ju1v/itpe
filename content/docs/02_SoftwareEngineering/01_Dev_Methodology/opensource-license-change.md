...
- [SBOM]({{< relref "/docs/02_SoftwareEngineering/05_SW_Quality/sbom" >}}) — 라이선스 현황 관리 도구
- [공급망 보안]({{< relref "/docs/06_InfoSecurity/02_SecuritySystems/supply-chain-security" >}}) — 오픈소스 공급망 보안
- [DevSecOps]({{< relref "/docs/02_SoftwareEngineering/01_Dev_Methodology/devsecops" >}}) — 라이선스 컴플라이언스 자동화
