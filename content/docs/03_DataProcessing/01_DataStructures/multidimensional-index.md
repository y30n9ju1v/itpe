...
- [이진 탐색 트리]({{< relref "/docs/03_DataProcessing/01_DataStructures/binary-search-tree" >}}) — 1차원 색인의 기초
- [RAG]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/rag-retrieval-augmented-generation" >}}) — HNSW 기반 벡터 검색 활용
- [데이터마이닝]({{< relref "/docs/03_DataProcessing/04_DataMining" >}}) — 공간 클러스터링과 연계
