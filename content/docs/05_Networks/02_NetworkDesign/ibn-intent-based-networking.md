...
- [네트워크 설계]({{< relref "/docs/05_Networks/02_NetworkDesign/igp-egp-routing" >}}) — 라우팅 정책과 연계
- [멀티클라우드]({{< relref "/docs/04_ComputerSystems/04_OS_Virtualization/multi-cloud" >}}) — 클라우드 환경 네트워크 자동화
