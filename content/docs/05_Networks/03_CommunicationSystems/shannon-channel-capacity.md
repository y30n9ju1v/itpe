...
- [AI-Native Network 6G]({{< relref "/docs/05_Networks/03_CommunicationSystems/ai-native-network-6g" >}}) — 6G에서 Shannon 한계 극복 기술
- [IEEE 802.11bn]({{< relref "/docs/05_Networks/01_Network_Protocol/ieee-802-11bn" >}}) — Wi-Fi에서의 채널 용량 기술
