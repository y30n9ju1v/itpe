...
- [ARQ 오류 제어]({{< relref "/docs/05_Networks/01_Network_Protocol/arq-error-control" >}}) — SRT의 패킷 손실 복구 기반
- [TLS 1.2 vs 1.3]({{< relref "/docs/05_Networks/01_Network_Protocol/tls-1-2-vs-1-3" >}}) — HTTPS 스트리밍 보안 기반
