...
- [OSI 7계층]({{< relref "/docs/05_Networks/01_Network_Protocol/osi-7-layer" >}}) — HDLC는 2계층 (데이터링크)
- [네트워크 프로토콜]({{< relref "/docs/05_Networks/01_Network_Protocol/network-protocol" >}}) — 프로토콜 3요소·기능
- [ARQ 오류 제어]({{< relref "/docs/05_Networks/01_Network_Protocol/arq-error-control" >}}) — HDLC의 오류 제어 방식
