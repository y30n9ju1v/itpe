...
- [오픈소스 DBMS 마이그레이션]({{< relref "/docs/03_DataProcessing/03_DBMS_Distributed/opensource-dbms-migration" >}}) — HA 구성 적용
- [DB 분할]({{< relref "/docs/03_DataProcessing/03_DBMS_Distributed/db-partitioning" >}}) — 분산 DB의 가용성 구성
