...
- [세그멘테이션 오류]({{< relref "/docs/04_ComputerSystems/05_Algorithms/segmentation-fault" >}}) — 잘못된 메모리 접근의 또 다른 유형
- [메모리 구조]({{< relref "/docs/04_ComputerSystems/05_Algorithms/memory-areas" >}}) — 힙·스택·코드 영역 상세
