...
- [OS 스케줄링]({{< relref "/docs/04_ComputerSystems/03_SystemSoftware/01_OS_Embedded/os-scheduling" >}}) — 프로세스 관리의 핵심
- [뱅커 알고리즘]({{< relref "/docs/04_ComputerSystems/05_Algorithms/banker-algorithm" >}}) — 교착상태 방지 (IPC의 동기화 문제와 연계)
