...
- [LLM 보안 위협]({{< relref "/docs/06_InfoSecurity/01_SecurityTech/llm-security-threats-owasp" >}}) — OWASP LLM Top 10 전체
- [프롬프트 인젝션]({{< relref "/docs/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — 또 다른 LLM 공격 유형 (미작성)
- [TTFT/TPOT]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/ttft-tpot-llm-performance" >}}) — LLM 성능 지표 (DoS로 악화)
