...
- [공격 표면/측면 이동]({{< relref "/docs/06_InfoSecurity/02_SecuritySystems/attack-surface-lateral-movement" >}}) — TTPs의 구체적 기법
- [랜섬웨어/RaaS]({{< relref "/docs/06_InfoSecurity/02_SecuritySystems/ransomware-raas" >}}) — TTPs 적용 대표 공격 유형
