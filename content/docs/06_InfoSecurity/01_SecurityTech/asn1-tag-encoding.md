...
- [보안 인증 체계]({{< relref "/docs/06_InfoSecurity/08_SecurityCertification" >}}) — X.509 PKI 인프라
- [해시 함수/암호화]({{< relref "/docs/06_InfoSecurity/01_SecurityTech/hash-function-rainbow-table" >}}) — 디지털 서명 기반
