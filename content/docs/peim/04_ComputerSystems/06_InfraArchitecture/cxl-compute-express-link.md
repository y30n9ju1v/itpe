...
- [GPU/TPU]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — CXL로 연결되는 AI 가속기
- [FTS/HA 인프라]({{< relref "/docs/peim/04_ComputerSystems/06_InfraArchitecture/fts-ha" >}}) — 고성능 인프라 아키텍처
