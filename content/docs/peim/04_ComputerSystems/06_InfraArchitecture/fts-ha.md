...
tags: ["peim", "컴퓨터시스템", "인프라아키텍처", "FTS", "HA", "고가용성", "가용성"]
draft: false
exam: "138회"
---
...
- [오픈소스 DBMS 마이그레이션]({{< relref "/docs/peim/03_DataProcessing/03_DBMS_Distributed/opensource-dbms-migration" >}}) — HA 구성 적용
- [DB 분할]({{< relref "/docs/peim/03_DataProcessing/03_DBMS_Distributed/db-partitioning" >}}) — 분산 DB의 가용성 구성
