...
- [DevOps 장단점]({{< relref "/docs/peim/02_SoftwareEngineering/01_Dev_Methodology/devops-pros-cons" >}}) — DevSecOps의 기반 방법론
- [SIEM과 SOAR]({{< relref "/docs/peim/06_InfoSecurity/02_SecuritySystems/siem-soar" >}}) — 운영 단계 보안 모니터링 연계
- [SW 보안 품질]({{< relref "/docs/peim/02_SoftwareEngineering/05_SW_Quality/sw-security-quality" >}}) — 보안 품질 요건
