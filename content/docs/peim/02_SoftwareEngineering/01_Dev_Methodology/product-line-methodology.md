...
- [테일러링]({{< relref "/docs/peim/02_SoftwareEngineering/01_Dev_Methodology/tailoring" >}}) — 방법론 적용 시 변형 전략
- [로우코드/노코드]({{< relref "/docs/peim/02_SoftwareEngineering/01_Dev_Methodology/low-code-no-code" >}}) — 공통 플랫폼 기반 빠른 제품 생산이라는 공통점
