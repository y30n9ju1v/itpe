...
- [소프트웨어 품질보증과 인스펙션]({{< relref "/docs/peim/02_SoftwareEngineering/05_SW_Quality/sw-quality-assurance-inspection" >}}) — SQA 전반과 연계
- [LLM 보안 위험]({{< relref "/docs/peim/06_InfoSecurity/01_SecurityTech/llm-security-risks" >}}) — AI 기반 SW 개발의 보안 품질 이슈
