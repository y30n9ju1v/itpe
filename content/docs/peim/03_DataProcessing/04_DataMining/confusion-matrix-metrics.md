...
- [아웃라이어 탐지]({{< relref "/docs/peim/03_DataProcessing/04_DataMining/outlier-detection" >}}) — 이상 탐지 모델 평가에 혼동행렬 활용
- [벡터 데이터베이스와 HNSW]({{< relref "/docs/peim/03_DataProcessing/04_DataMining/vector-database-hnsw-ivf" >}}) — AI 모델 파이프라인 연계
