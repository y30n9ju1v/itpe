...
- [AI RMF]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/ai-rmf" >}}) — NIST AI 위험관리 프레임워크
- [ISO/IEC 42001]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/iso-iec-42001" >}}) — AI 경영시스템 표준
- [에이전틱 AI]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/agentic-ai" >}}) — GPAI의 자율행동 형태
