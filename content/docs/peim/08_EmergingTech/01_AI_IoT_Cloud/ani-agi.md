...
- [멀티모달 LLM]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/multimodal-llm" >}}) — ANI의 실현 형태
- [AI RMF]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/ai-rmf" >}}) — AGI 전환 과정의 위험 관리
- [AI 거버넌스]({{< relref "/docs/peim/01_InfoStrategy/03_AI_Ethics/ai-governance" >}}) — AGI 시대 윤리·규제
