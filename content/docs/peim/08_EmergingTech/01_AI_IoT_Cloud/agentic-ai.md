...
- [MCP (Model Context Protocol)]({{< relref "/docs/peim/06_InfoSecurity/03_InfoProtection/mcp-security" >}}) — 에이전트 도구 연동 표준 프로토콜
- [범용 AI 위험관리 프레임워크]({{< relref "/docs/peim/08_EmergingTech/01_AI_IoT_Cloud/general-purpose-ai-risk-framework" >}}) — 에이전틱 AI의 거버넌스 기반
- [LLM 보안 위험]({{< relref "/docs/peim/06_InfoSecurity/01_SecurityTech/llm-security-risks" >}}) — LLM08 Excessive Agency
