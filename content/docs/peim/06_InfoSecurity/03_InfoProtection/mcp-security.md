...
- [프롬프트 인젝션]({{< relref "prompt-injection" >}}) — MCP 환경의 주요 공격 벡터
- [AI 거버넌스]({{< relref "ai-governance" >}}) — MCP 보안 정책의 상위 체계
- [공격 표면/측면 이동]({{< relref "attack-surface-lateral-movement" >}}) — MCP가 확장하는 공격 표면
