...
- [프롬프트 인젝션]({{< relref "/docs/peim/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — MCP 환경의 주요 공격 벡터
- [AI 거버넌스]({{< relref "/docs/peim/01_InfoStrategy/03_AI_Ethics/ai-governance" >}}) — MCP 보안 정책의 상위 체계
- [공격 표면/측면 이동]({{< relref "/docs/peim/06_InfoSecurity/02_SecuritySystems/attack-surface-lateral-movement" >}}) — MCP가 확장하는 공격 표면
