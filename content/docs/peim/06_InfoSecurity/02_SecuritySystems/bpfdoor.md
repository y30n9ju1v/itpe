...
- [TTPs]({{< relref "ttps" >}}) — BPFdoor 공격의 TTPs 분류
- [디지털 포렌식 아티팩트]({{< relref "digital-forensics-artifact" >}}) — BPFdoor 탐지 시 아티팩트
- [N²SF]({{< relref "n2sf-network-security" >}}) — 망 보안체계로 초기 침투 차단
