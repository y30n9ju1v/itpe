...
- [ARQ 오류제어]({{< relref "/docs/peim/05_Networks/01_Network_Protocol/arq-error-control" >}}) — HARQ의 기반이 되는 오류 제어 기법
- [6G 이동통신]({{< relref "/docs/peim/05_Networks/03_CommunicationSystems/ai-native-network-6g" >}}) — 무선 통신 기술 발전 흐름
