...
- [타원곡선 암호 ECC]({{< relref "/docs/peim/06_InfoSecurity/01_SecurityTech/ecc-elliptic-curve-cryptography" >}}) — TLS 1.3의 ECDHE 기반
- [암호문 공격 유형]({{< relref "/docs/peim/06_InfoSecurity/01_SecurityTech/ciphertext-attack" >}}) — POODLE·BEAST 공격 배경
