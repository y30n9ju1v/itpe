...
- [양자 머신러닝 (QML)]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/quantum-machine-learning" >}}) — 양자 컴퓨팅 기반 AI (TurboQuant와는 다른 개념)
- [GPU·TPU]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — 양자화 이득이 발생하는 하드웨어 맥락
- [sLLM (소형 언어모델)]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/sllm-smaller-llm" >}}) — 경량화의 다른 접근법
