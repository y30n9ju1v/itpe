...
- [sLLM (소형 대형 언어 모델)]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/sllm-smaller-llm" >}}) — 온디바이스 AI의 핵심 모델
- [지능형 엣지 컴퓨팅]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/intelligent-edge-computing" >}}) — 온디바이스 AI의 인프라 맥락
- [GPU/TPU]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — 클라우드 AI 실행 하드웨어
