...
- [디지털서비스 전문계약제도]({{< relref "/docs/08_EmergingTech/03_Regulations_Policies/digital-service-contract" >}}) — SaaS·PaaS의 공공 조달 방식
- [AIaaS]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/ai-as-a-service" >}}) — SaaS 계층의 AI 특화 서비스
- [클라우드 네이티브 보안]({{< relref "/docs/06_InfoSecurity/03_InfoProtection/cloud-native-security" >}}) — PaaS/FaaS 보안
