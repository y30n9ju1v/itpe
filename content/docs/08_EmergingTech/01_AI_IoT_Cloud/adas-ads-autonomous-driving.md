...
- [ISO/PAS 8800:2024]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/iso-pas-8800-ai-safety" >}}) — 자율주행 AI 안전 표준
- [스마트선박 자율운항]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/smart-ship-autonomous-navigation" >}}) — IMO 자율화 등급 연계
