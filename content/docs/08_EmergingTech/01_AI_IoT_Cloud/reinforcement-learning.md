...
- [RLHF·RAFT]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/rlhf-raft" >}}) — LLM 정렬에서의 강화학습 활용
- [시계열 딥러닝]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/time-series-deep-learning" >}}) — VPP 전력 수요 예측과 함께 활용
- [GNN]({{< relref "/docs/08_EmergingTech/01_AI_IoT_Cloud/gnn-graph-neural-network" >}}) — VPP 전력망 토폴로지 모델링
