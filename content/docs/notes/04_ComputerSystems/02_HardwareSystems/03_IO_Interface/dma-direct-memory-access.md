...
- [인터럽트 처리]({{< relref "/docs/notes/04_ComputerSystems/03_SystemSoftware/01_OS_Embedded" >}}) — DMA 완료 인터럽트 처리
- [HBM]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/high-bandwidth-memory" >}}) — 고대역폭 메모리와 DMA 연계
