...
- [클라우드 AI vs 온디바이스 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/cloud-ai-vs-ondevice-ai" >}}) — NPU가 온디바이스 AI의 핵심 HW
- [GPU/TPU]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — AI 학습용 가속기와의 비교
