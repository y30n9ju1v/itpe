...
- [고대역 초고속 메모리(HBM)]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/high-bandwidth-memory" >}}) — AI 가속기의 메모리 대역폭
- [GPU/TPU]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — AI 데이터센터의 핵심 연산 자원
- [FTS/HA]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/fts-ha" >}}) — 데이터센터 고가용성 아키텍처
- [멀티 GPU 기술]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/multi-gpu-training" >}}) — 분산 학습 기법
