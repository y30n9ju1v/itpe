...
- [FTS/HA]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/fts-ha" >}}) — 서버 이중화의 상위 개념 (HA 시스템)
- [무중단 배포]({{< relref "/docs/notes/02_SoftwareEngineering/03_Implementation_Testing/deployment-strategy" >}}) — 이중화 구성에서의 배포 전략
- [멀티클라우드]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/multicloud" >}}) — 클라우드 환경에서의 글로벌 LB
