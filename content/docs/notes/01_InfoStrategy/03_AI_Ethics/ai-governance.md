...
- [AI RMF]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/ai-rmf" >}}) — AI 위험관리 프레임워크
- [ISO/IEC 42001]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/iso-iec-42001" >}}) — AI 관리시스템 인증
- [인공지능기본법]({{< relref "/docs/notes/08_EmergingTech/03_Regulations_Policies/ai-basic-law" >}}) — 국내 AI 거버넌스 법적 근거
- [AI 신뢰성 검인증(CAT)]({{< relref "/docs/notes/01_InfoStrategy/03_AI_Ethics/ai-cat-certification" >}}) — 기술적 거버넌스 수단
