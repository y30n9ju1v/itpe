...
- [클라우드 AI vs 온디바이스 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/cloud-ai-vs-ondevice-ai" >}}) — sLLM의 주요 실행 환경
- [RAG]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/rag-retrieval-augmented-generation" >}}) — sLLM과 RAG 결합으로 도메인 지식 강화
- [대규모 AI/LLM 아키텍처]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/llm-architecture-public-sector" >}}) — LLM 대비 sLLM의 위치
