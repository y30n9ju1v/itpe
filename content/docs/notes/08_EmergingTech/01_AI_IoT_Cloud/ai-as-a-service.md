...
- [클라우드 컴퓨팅 서비스 유형]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/public-sector-saas-guideline" >}}) — IaaS/PaaS/SaaS와의 관계
- [RAG]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/rag-retrieval-augmented-generation" >}}) — AIaaS 기반 RAG 구현
- [클라우드 AI vs 온디바이스 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/cloud-ai-vs-ondevice-ai" >}}) — AIaaS는 클라우드 AI의 서비스 형태
