...
- [GPU/TPU]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — 멀티 GPU의 개별 단위
- [HBM]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/high-bandwidth-memory" >}}) — GPU 메모리 대역폭
- [AI 데이터센터]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/ai-datacenter-tech" >}}) — 멀티 GPU 클러스터 인프라
- [AI 윤리 및 법적 이슈]({{< relref "/docs/notes/01_InfoStrategy/03_AI_Ethics/ai-ethics-generative-ai" >}}) — AI 시스템의 윤리적 문제
