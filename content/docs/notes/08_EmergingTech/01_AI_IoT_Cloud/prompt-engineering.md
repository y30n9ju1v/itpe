...
- [공공기관 LLM 아키텍처]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/llm-architecture-public-sector" >}}) — 프롬프트 엔지니어링 적용 맥락
- [프롬프트 인젝션]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — 프롬프트 엔지니어링의 보안 위협
