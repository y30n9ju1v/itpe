...
- [Self-Attention 메커니즘]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/self-attention-mechanism" >}}) — TTFT의 Prefill 단계에서 실행
- [Model DoS]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/model-dos-llm-attack" >}}) — TTFT/TPOT 악화를 유발하는 공격
- [LLM 보안 위협]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/llm-security-threats-owasp" >}}) — LLM 운영 전체 보안 위협
