...
- [ISO/IEC 42001]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/iso-iec-42001" >}}) — AI 관리시스템 국제 인증 표준
- [프롬프트 인젝션]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — AI 보안 위협의 대표 사례
- [모델 전도 공격]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/model-inversion-attack" >}}) — AI 프라이버시 위협
