...
- [Transformer/MoE]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/transformer-moe" >}}) — 어텐션 기반 딥러닝 아키텍처
- [초거대 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/large-scale-ai" >}}) — GNN을 포함한 현대 AI 아키텍처
- 데이터마이닝 — 그래프 기반 패턴 분석
