...
- [스마트팩토리 / IIoT]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/general-purpose-ai-risk-framework" >}}) — OPC UA의 핵심 적용 도메인
- [Modbus 프로토콜]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/modbus-protocol" >}}) — 구형 산업 프로토콜 (OPC UA로 대체)
- [IEC 표준]({{< relref "/docs/notes/07_SystemEvaluation/02_HW_SW_Standards/ieee-iec-standards-comparison" >}}) — OPC UA = IEC 62541
