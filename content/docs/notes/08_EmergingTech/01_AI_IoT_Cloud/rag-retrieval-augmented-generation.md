...
- [프롬프트 엔지니어링]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/prompt-engineering" >}}) — RAG는 컨텍스트 강화 프롬프트 기법
- [Agentic AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/agentic-ai" >}}) — RAG를 도구로 사용하는 AI 에이전트
- [GNN (그래프 신경망)]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/gnn-graph-neural-network" >}}) — GraphRAG의 기반
- [다차원 색인구조]({{< relref "/docs/notes/03_DataProcessing/01_DataStructures/multidimensional-index" >}}) — 벡터 DB ANN 검색의 기반
