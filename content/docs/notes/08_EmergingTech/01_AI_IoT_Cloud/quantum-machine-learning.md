...
- [양자 암호(PQC·QKD)]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/quantum-cryptography-qkd-pqc" >}}) — 양자컴퓨팅의 보안 응용
- [GPU/TPU]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/gpu-tpu" >}}) — 고전 ML 하드웨어와 비교
- 데이터마이닝 — QML의 응용 도메인
