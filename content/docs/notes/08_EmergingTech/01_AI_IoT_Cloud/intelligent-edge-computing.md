...
tags: ["peim", "pecs", "최신기술", "AI", "엣지컴퓨팅", "IoT", "MEC", "온디바이스AI"]
draft: false
exam_peim: ["139회"]
exam_pecs: ["135회", "137회"]
---
...
- [클라우드 AI vs 온디바이스 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/cloud-ai-vs-ondevice-ai" >}}) — 온디바이스 AI의 인프라 확장
- [AI-Native Network / 6G]({{< relref "/docs/notes/05_Networks/03_CommunicationSystems/ai-native-network-6g" >}}) — MEC와 6G 연계
- [스마트 팩토리]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/general-purpose-ai-risk-framework" >}}) — 지능형 엣지의 주요 적용 도메인
