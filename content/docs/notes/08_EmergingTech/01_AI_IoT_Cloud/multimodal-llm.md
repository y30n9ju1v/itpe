...
- [LLM 아키텍처와 공공기관 적용]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/llm-architecture-public-sector" >}}) — 공공부문 LLM 5가지 고려사항
- [VAE(Variational AutoEncoder)]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/vae-variational-autoencoder" >}}) — 생성 모델 기반 기술
- [프롬프트 엔지니어링]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/prompt-engineering" >}}) — LLM 활용 기술
