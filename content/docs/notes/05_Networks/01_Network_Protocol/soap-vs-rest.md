...
- [Open API]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/open-api" >}}) — REST 기반 공개 API 설계 원칙
- [MSA]({{< relref "/docs/notes/02_SoftwareEngineering/02_Analysis_Design/ta-aa-architect" >}}) — 마이크로서비스 간 통신에 REST/gRPC 활용
