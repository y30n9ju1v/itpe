...
- [ARQ/오류제어]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/arq-error-control" >}}) — ARQ와 슬라이딩 윈도우의 상세
- [IGP/EGP]({{< relref "/docs/notes/05_Networks/02_NetworkDesign/igp-egp-routing" >}}) — 네트워크 계층 라우팅
- [AI-Native Network]({{< relref "/docs/notes/05_Networks/03_CommunicationSystems/ai-native-network-6g" >}}) — 6G 혼잡 제어 AI화
