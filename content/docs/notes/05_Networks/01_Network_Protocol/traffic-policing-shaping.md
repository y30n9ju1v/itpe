...
- [네트워크 설계]({{< relref "/docs/notes/05_Networks/02_NetworkDesign/ibn-intent-based-networking" >}}) — QoS 정책 기반 네트워크 설계
- [채널용량]({{< relref "/docs/notes/05_Networks/03_CommunicationSystems/shannon-channel-capacity" >}}) — 이론적 대역폭 한계
