...
- [TLS 1.2 vs 1.3]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/tls-1-2-vs-1-3" >}}) — DoT/DoH의 기반 보안 프로토콜
- [침입탐지시스템(IDS)]({{< relref "/docs/notes/06_InfoSecurity/02_SecuritySystems/siem-soar" >}}) — DNS 터널링 탐지
- [네트워크 설계]({{< relref "/docs/notes/05_Networks/02_NetworkDesign" >}}) — DNS 이중화 설계
