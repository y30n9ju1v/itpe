...
- [프롬프트 인젝션]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — LLM01 상세 분석
- [모델 반전 공격]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/model-inversion-attack" >}}) — LLM06 관련
- [에이전틱 AI]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/agentic-ai" >}}) — LLM08 Excessive Agency와 직결
