...
- [모델 전도 공격]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/model-inversion-attack" >}}) — 해시 역추론과 유사한 공격 개념
- [PET]({{< relref "/docs/notes/06_InfoSecurity/06_PrivacyProtection/pet-privacy-enhancing-technology" >}}) — 동형암호 등 고급 프라이버시 기술
- 디지털 서명 — 해시 함수 핵심 활용
