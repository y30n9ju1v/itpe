...
- [TLS 1.2 취약점과 TLS 1.3]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/tls-1-2-vs-1-3" >}}) — ECDHE 기반 TLS 1.3
- [해시함수와 Rainbow Table]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/hash-function-rainbow-table" >}}) — 암호 시스템의 또 다른 핵심 요소
