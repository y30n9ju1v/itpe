...
- [ISMS·ISMS-P]({{< relref "/docs/notes/06_InfoSecurity/04_AdminSecurity/isms-isms-p" >}}) — 정보보호 관리 인증과의 차이
- [소프트웨어 보안 품질]({{< relref "/docs/notes/02_SoftwareEngineering/05_SW_Quality/sw-security-quality" >}}) — CC 기반 제품 보안 평가
