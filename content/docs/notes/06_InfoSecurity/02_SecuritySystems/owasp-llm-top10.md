...
- [LLM 보안 위험과 대응방안]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/llm-security-risks" >}}) — LLM 보안 위험 심화 분석
- [프롬프트 인젝션]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/prompt-injection" >}}) — LLM01 상세
- [공급망 보안]({{< relref "/docs/notes/06_InfoSecurity/02_SecuritySystems/supply-chain-security" >}}) — LLM05 공급망 취약점과 연계
