...
- [TTPs]({{< relref "/docs/notes/06_InfoSecurity/01_SecurityTech/ttps" >}}) — BPFdoor 공격의 TTPs 분류
- [디지털 포렌식 아티팩트]({{< relref "/docs/notes/06_InfoSecurity/05_DigitalForensics/digital-forensics-artifact" >}}) — BPFdoor 탐지 시 아티팩트
- [N²SF]({{< relref "/docs/notes/06_InfoSecurity/03_InfoProtection/n2sf-network-security" >}}) — 망 보안체계로 초기 침투 차단
