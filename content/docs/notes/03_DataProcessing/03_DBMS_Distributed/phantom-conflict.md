...
- [트랜잭션 격리 수준]({{< relref "/docs/notes/03_DataProcessing/03_DBMS_Distributed/transaction-isolation-level" >}}) — 격리 수준 전체 체계
- [확장성 해싱]({{< relref "/docs/notes/03_DataProcessing/01_DataStructures/extendible-hashing" >}}) — 동시 접근 충돌 관련 자료구조
