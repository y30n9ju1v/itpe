...
- [DB 인덱스]({{< relref "/docs/notes/03_DataProcessing/03_DBMS_Distributed/db-index-clustered-nonclustered" >}}) — 인덱스의 회복 시 처리
- [DB 파티셔닝]({{< relref "/docs/notes/03_DataProcessing/03_DBMS_Distributed/db-partitioning" >}}) — 분산 DB에서의 회복 복잡성
