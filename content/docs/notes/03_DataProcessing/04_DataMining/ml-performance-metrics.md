...
- [데이터마이닝]({{< relref "/docs/notes/03_DataProcessing/04_DataMining" >}}) — 머신러닝 기반 패턴 탐지
- [이미지 데이터 어노테이션]({{< relref "/docs/notes/03_DataProcessing/04_DataMining/data-annotation" >}}) — 성능지표 산출의 전제
- [SOM (Self Organizing Map)]({{< relref "/docs/notes/03_DataProcessing/04_DataMining/self-organizing-map" >}}) — 비지도 군집화 기법
