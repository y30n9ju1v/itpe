...
- [혼동 행렬과 분류 지표]({{< relref "/docs/notes/03_DataProcessing/04_DataMining/confusion-matrix-metrics" >}}) — TP/FP/TN/FN 기반 지표
- [실루엣 계수]({{< relref "/docs/notes/03_DataProcessing/04_DataMining/silhouette-coefficient" >}}) — 클러스터링 평가 지표
