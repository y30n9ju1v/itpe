...
- [DevOps 장단점]({{< relref "/docs/notes/02_SoftwareEngineering/01_Dev_Methodology/devops-pros-cons" >}}) — DevOps 원칙
- [AI RMF]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/ai-rmf" >}}) — MLOps 위험 관리 연계
- [RAG]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/rag-retrieval-augmented-generation" >}}) — LLM 기반 MLOps 활용 사례
