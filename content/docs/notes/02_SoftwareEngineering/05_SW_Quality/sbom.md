...
- [공급망 보안]({{< relref "/docs/notes/06_InfoSecurity/02_SecuritySystems/supply-chain-security" >}}) — SBOM은 SW 공급망 보안의 핵심 수단
- [소프트웨어 테스트]({{< relref "/docs/notes/02_SoftwareEngineering/03_Implementation_Testing/sw-testing" >}}) — 오픈소스 취약점 테스트 포함
