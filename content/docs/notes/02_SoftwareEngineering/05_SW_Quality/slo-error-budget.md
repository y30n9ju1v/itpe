...
- [SLA(서비스 수준 협약)]({{< relref "/docs/notes/02_SoftwareEngineering/05_SW_Quality/sla-service-level-agreement" >}}) — SLO와 SLA의 관계
- [FTS/HA]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/fts-ha" >}}) — 고가용성 인프라로 에러 버짓 확보
- [공공망 백업복구]({{< relref "/docs/notes/04_ComputerSystems/06_InfraArchitecture/public-network-backup-recovery" >}}) — 가용성 SLO 확보 사례
