...
- [SOAP vs REST]({{< relref "/docs/notes/05_Networks/01_Network_Protocol/soap-vs-rest" >}}) — MSA 서비스 간 통신 방식
- [TA/AA 아키텍처]({{< relref "/docs/notes/02_SoftwareEngineering/02_Analysis_Design/ta-aa-architect" >}}) — MSA 적용 아키텍처 설계
- [무중단 배포]({{< relref "/docs/notes/02_SoftwareEngineering/03_Implementation_Testing/deployment-strategy" >}}) — MSA에서의 배포 전략
