...
- [임베디드 OS]({{< relref "/docs/notes/04_ComputerSystems/03_SystemSoftware/01_OS_Embedded" >}}) — SIL/HIL의 대상 소프트웨어
- [SW 품질 및 테스트]({{< relref "/docs/notes/02_SoftwareEngineering/05_SW_Quality" >}}) — V-모델과 테스트 유형
- [ADAS/자율주행]({{< relref "/docs/notes/08_EmergingTech/01_AI_IoT_Cloud/adas-ads-autonomous-driving" >}}) — SIL/HIL의 주요 적용 도메인
